...
### João Gabriel Gonçalez (Porta-voz)
- **Formação**:
  - Técnico em Desenvolvimento de Sistemas (SENAI)
  - (1º) Desafio de Ideias (MAXION)
  - Engenharia da Computação (FHO-UNIARARAS)

### Henrique Rodrigues Motta
- **Formação**: 
  - Técnico em Eletroeletrônica (Trajano)
  - Iniciação Científica - Sistemas Embarcados (Unicamp)
  - Técnico em Desenvolvimento de Sistemas (SENAI)
...
- **Formação**:
  ...
  - Técnico em Desenvolvimento de Sistemas (COTIL)
  - (1º) Resolve Aí (Mahle)
